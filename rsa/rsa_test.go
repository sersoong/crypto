...
func TestEncryptPEMRSA(t *testing.T) {
	...
	//t.Log(base64Prikey)
	//t.Log(string(pubkey))
	pubkey := "-----BEGIN PUBLIC KEY-----\\n6ld+0VbiKvmcUr5ZYNS1DX2aw5uJUPg4bQIDAQAB\n-----END PUBLIC KEY-----"
	plaintext := "helloworld"
	cipherText, err := EncryptPEMRSA(ctx, []byte(plaintext), []byte(pubkey))
	if err != nil {
		t.Fatal(err.Error())
	}
...
func TestDecryptPEMRSA(t *testing.T) {
	ctx := gctx.New()
	prikey := ""
	cipherText := ""
